...
class Window extends EventEmitter{
  ...
  get feedback(){
    let {title, active, fullscreen, loop, fps, width, height, x, y, cursor, fit, visible} = this.state
    return [
      this.canvas.pages[this.page-1][ø],
      title, active, fullscreen, loop ? fps : 0, width, height, x, y, cursor, fit, visible
    ]
  }
