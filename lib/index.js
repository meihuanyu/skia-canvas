...
class Path2D extends RustClass{
  ...
  static simplified(path){
    return wrap(Path2D, path.ƒ("simplify"))
  }
  ...
  // elide overlaps
  simplify(){       return Path2D.simplified(this) }
}
...
class Window extends EventEmitter{
  ...
  display(){
    ...
    if (!this.state.active){
      ...
      neon.Window.display(context, dispatch, animate, background, width, height)
      this.state.active = false
    }
  }
